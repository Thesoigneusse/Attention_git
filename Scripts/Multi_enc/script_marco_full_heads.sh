...
ATTENTION_GIT = "/home/getalp/lopezfab/lig/Attention_git"
base_command="python3 $ATTENTION_GIT/marco_script/match-nmt2parcorfull.py /home/getalp/lopezfab/lig/Attention/k3/GOLD/test.en /home/getalp/lopezfab/lig/Attention/k3/GOLD/test.de $ATTENTION_GIT/marco_script/list_filename_matrice/multi_enc/full_matrice/list_chemin_0_0_tsv.txt --output-file=$ATTENTION_GIT/Output/debug.results --canmt-system=multienc --pudb=False"
