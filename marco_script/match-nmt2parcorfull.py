...
def match_nmt2parcorfull(src_nmt, disco_src_pcf, news_src_pcf):
    ...
    Returns a list where each element is a list itself containing:
     1. The NMT system input/output sentence : type = string
     2. The corresponding raw ParCorFull 2 corpus sentence : type = string
     3. The sequence of uniq token identifiers for tokens in the corpus sentence : type = list of int
     4. The corresponding tokenized ParCorFull 2 corpus sentence : type = string
     5. The same sentence as in 1. annotated with mentions, in the form of tokens "decorated" with [<token>]set_idxxx : type = string
    """
